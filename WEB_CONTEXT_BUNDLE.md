...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.38"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-v1",
      "problem_contract_sha256": "d74afc03734de467da33cfa24125b3743703fd37454b9254ad74341b4c300e7c",
      "problem_id": "problem:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81",
      "route_id": "route:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-source-fidelity-01",
      "graph_id": "graph:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "The spread of a group $G$ is the greatest nonnegative integer $k$ such that for all nontrivial elements $x_1,\\ldots,x_k\\in G$ there exists $y\\in G$ such that $\\langle x_1,y\\rangle=\\cdots=\\langle x_k,y\\rangle=G$, or is $\\infty$ in case there is no such maximum. Does there exist a group with spread equal to 1?"
          },
          "statement_sha256": "2ebbf48af9b7578f0a1326b4c623fa25ddda5d6f52dbc0ee2634b50cbe8c06c1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-root",
      "route_id": "route:um-kou-21.38-kourovka-notebook-problem-21.38-cf562e81-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.38-39fc9b4ae01d",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.38"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
